...
class FichaEmpresasPage extends StatefulWidget {
  const FichaEmpresasPage({super.key});

  @override
  State<FichaEmpresasPage> createState() => _FichaEmpresasPageState();
}

class _FichaEmpresasPageState extends State<FichaEmpresasPage> {
  Map datamap = {};
  ...
  void initState() {
    super.initState();
    DatabaseReference dbRef = FirebaseDatabase.instance.ref().child('empresas');
                                                  ...
                                                  child: CircleAvatar(
                                                      ...
                                                      backgroundImage: datamap[datamap.keys.elementAt(index)]
                                                          ...
                                                          ? NetworkImage(
                                                              datamap[datamap.keys.elementAt(index)]
                                                                  ["img"])
                                                          : NetworkImage(datamap[datamap.keys.elementAt(index)]["bw_img"])),
                                                ),
                                                Padding(
