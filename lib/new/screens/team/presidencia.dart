...
class PresidenciaPage extends StatefulWidget {
  const PresidenciaPage({super.key});

  @override
  State<PresidenciaPage> createState() => _PresidenciaPageState();
}

class _PresidenciaPageState extends State<PresidenciaPage> {
  Map datamap = {};
  ...
  void initState() {
    ...
    DatabaseReference dbRef =
        FirebaseDatabase.instance.ref().child('equipa').child('presidencia');
